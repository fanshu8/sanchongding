...
const getFAQData = (language: 'zh' | 'en'): FAQData => {
  if (language === 'zh') {
    return {
      course: [
        {
          question: '什么是 Suncheer Forex 数字货币交易员培训？',
    ...
    return {
      course: [
        {
          question: 'What is Suncheer Forex Cryptocurrency Trader Training?',
    ...
    >
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div
              className="px-6 pb-6 pt-2 pl-12 text-gray-700 dark:text-gray-300 text-base leading-relaxed border-t-2 border-gray-100 dark:border-gray-700"
...
export default function FAQPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-primary border-b-2 border-gray-800">
      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        ...
        >
          <div className="relative max-w-2xl mx-auto">
            ...
            <div className="absolute right-2 top-1/2 -translate-y-1/2">
              <span className="px-6 py-3 bg-secondary text-white font-bold text-sm">
                {t('faq.search.button')}
              </span>
            </div>
          </div>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-black text-primary">{t('faq.category.course')}</h2>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            <div className="w-1 h-12 bg-secondary"></div>
            <h2 className="text-3xl font-black text-primary">{t('faq.category.support')}</h2>
            <span className="px-4 py-2 bg-black dark:bg-white text-white dark:text-black text-sm font-bold">
        ...
        >
          ...
          <div className="relative bg-primary p-12 border-2 border-black dark:border-white text-center">
            <div className="mb-6">
