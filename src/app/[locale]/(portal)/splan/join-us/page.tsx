...
export default function JoinUsPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      {/* Hero - 增强版 */}
      <div className="relative bg-gradient-to-r from-primary to-primary/90 text-white border-b-2 border-secondary overflow-hidden">
        {/* 装饰性背景 */}
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6">
            <span className="inline-block"><BrandName /></span>
            <br />
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4 text-sm">
            <div className="px-4 py-2 bg-white/5 border border-white/20 backdrop-blur-sm">
              <span className="text-accent font-bold">{t('joinus.hero.stat1.value')}</span> {t('joinus.hero.stat1')}
            </div>
            <div className="px-4 py-2 bg-white/5 border border-white/20 backdrop-blur-sm">
              <span className="text-accent font-bold">{t('joinus.hero.stat2.value')}</span> {t('joinus.hero.stat2')}
            </div>
            <div className="px-4 py-2 bg-white/5 border border-white/20 backdrop-blur-sm">
              <span className="text-accent font-bold">{t('joinus.hero.stat3.value')}</span> {t('joinus.hero.stat3')}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-20 space-y-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 p-8 border-2 border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-12 h-12 flex items-center justify-center text-2xl text-secondary">
        ...
        <section>
          ...
          <div style={{display: 'flex', flexDirection: 'column', gap: '30px'}}>
            {/* Phase 1 */}
            <div className="bg-background dark:bg-gray-800 border-2 border-gray-300 dark:border-white p-8">
              <h3 className="text-3xl font-black mb-3 text-gray-900 dark:text-white">{t('joinus.plan.phase1.title')}</h3>
              <div className="inline-block px-4 py-1 bg-secondary text-white text-sm font-bold mb-4">
              ...
              <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2 mb-4">
                <li><span className="text-blue-600 dark:text-blue-400 font-bold">{language === 'zh' ? '考核要求' : 'Requirement'}</span>：{t('joinus.plan.phase1.req')}</li>
                <li className="text-gray-500 dark:text-gray-500 italic">{t('joinus.plan.phase1.warning')}</li>
              </ul>
            </div>

            {/* Phase 2 */}
            <div className="bg-background dark:bg-gray-800 border-2 border-gray-300 dark:border-white p-8">
              <h3 className="text-3xl font-black mb-3 text-gray-900 dark:text-white">{t('joinus.plan.phase2.title')}</h3>
              <div className="inline-block px-4 py-1 bg-secondary text-white text-sm font-bold mb-4">
              ...
              <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2 mb-4">
                <li><span className="font-bold">{language === 'zh' ? '第一周' : 'Week 1'}</span>：{t('joinus.plan.phase2.week1')}</li>
                <li><span className="font-bold">{language === 'zh' ? '第二周' : 'Week 2'}</span>：{t('joinus.plan.phase2.week2')}</li>
                <li><span className="font-bold">{language === 'zh' ? '第三周' : 'Week 3'}</span>：{t('joinus.plan.phase2.week3')}</li>
              </ul>
            </div>

            {/* Phase 3 */}
            <div className="bg-background dark:bg-gray-800 border-2 border-gray-300 dark:border-white p-8">
              <h3 className="text-3xl font-black mb-3 text-gray-900 dark:text-white">{t('joinus.plan.phase3.title')}</h3>
              <div className="inline-block px-4 py-1 bg-secondary text-white text-sm font-bold mb-4">
              ...
              <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2 mb-4">
                <li><span className="text-blue-600 dark:text-blue-400 font-bold">{language === 'zh' ? '盈利要求' : 'Profit requirement'}</span>：{t('joinus.plan.phase3.req')}</li>
                <li className="text-gray-500 dark:text-gray-500 italic">{t('joinus.plan.phase3.warning')}</li>
              </ul>
            </div>

            {/* Phase 4 */}
            <div className="bg-background dark:bg-gray-800 border-2 border-gray-300 dark:border-white p-8">
              <h3 className="text-3xl font-black mb-3 text-gray-900 dark:text-white">{t('joinus.plan.phase4.title')}</h3>
              <div className="inline-block px-4 py-1 bg-secondary text-white text-sm font-bold mb-4">
              ...
              <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2 mb-4">
                ...
                <li className="text-gray-500 dark:text-gray-500 italic">{t('joinus.plan.phase4.warning')}</li>
              </ul>
            </div>

            {/* Phase 5 */}
            <div className="bg-background dark:bg-gray-800 border-2 border-gray-300 dark:border-white p-8">
              <h3 className="text-3xl font-black mb-3 text-gray-900 dark:text-white">{t('joinus.plan.phase5.title')}</h3>
              <div className="inline-block px-4 py-1 bg-secondary text-white text-sm font-bold mb-4">
              ...
              <div className="bg-background dark:bg-gray-900 p-4 border-l-4 border-secondary mb-4">
                <p className="text-sm font-bold text-gray-900 dark:text-white mb-2">{language === 'zh' ? '分成政策' : 'Profit Sharing'}</p>
                <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
                  <li><span className="text-blue-600 dark:text-blue-400 font-bold">{language === 'zh' ? '单量' : 'Volume'}</span>：{t('joinus.plan.phase5.1')}</li>
                  <li><span className="text-blue-600 dark:text-blue-400 font-bold">{language === 'zh' ? '回撤' : 'Drawdown'}</span>：{t('joinus.plan.phase5.2')}</li>
                  <li><span className="text-blue-600 dark:text-blue-400 font-bold">{language === 'zh' ? '分成' : 'Split'}</span>：{t('joinus.plan.phase5.3')}</li>
                  <li className="text-red-600 dark:text-red-400 font-bold">{language === 'zh' ? '⚠️ 亏损规则' : '⚠️ Loss Rule'}：{t('joinus.plan.phase5.4')}</li>
                  <li className="text-gray-500 dark:text-gray-500 italic">{language === 'zh' ? '案例' : 'Example'}：{t('joinus.plan.phase5.5')}</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="text-center bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 p-12 border-2 border-gray-200 dark:border-gray-700">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <LocaleLink
              ...
              className="px-10 py-4 bg-secondary hover:bg-secondary/80 text-white font-bold text-lg border-2 border-transparent transition-all hover:shadow-lg"
            >
              {t('joinus.cta.psychology')}
            </LocaleLink>
            <ShineButton
              onClick={handleApply}
              className="px-10 py-4 bg-accent hover:bg-accent/90 text-white font-bold text-lg border-2 border-transparent transition-all hover:shadow-lg animate-shake"
            >
      ...
      <EmailContactModal
        ...
        title={language === 'zh' ? '数字货币交易员面试' : 'Crypto Trader Interview'}
      />
    </div>
  );
}
