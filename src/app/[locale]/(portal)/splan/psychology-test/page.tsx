                    ...
                    <motion.button
                      ...
                      className={`w-full p-5 text-left border-2 transition-all ${
                        answers[currentQuestionIndex] === index
                          ...
                          : 'bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 hover:border-secondary hover:bg-secondary/10'
                      }`}
                    >
                      {option.text}
                    </motion.button>
            ...
            >
              ...
              <div className="flex justify-center gap-4">
                <ShineButton
                  ...
                  className="px-8 py-4 bg-secondary hover:bg-secondary/80 text-white font-semibold border-2 border-transparent transition-colors"
                >
                  {t('psytest.result.retry')}
                </ShineButton>
                <a
                  href="/splan/join-us"
                  className="px-8 py-4 bg-accent hover:bg-accent/90 text-white font-semibold border-2 border-transparent transition-colors"
                >
                  {language === 'zh' ? '预约面试' : 'Book Interview'}
                </a>
              </div>
            </motion.div>
          )}
