...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return generateBilingualMetadata(
    'SuncheerForex 博客 - 外汇交易知识与市场洞察丨三重鼎丨外汇交易员培训、全职交易员培训',
    'SuncheerForex Blog - Forex Trading Insights & Market Analysis丨SuncheerForex丨Forex Trader Training, Full-Time Trader Training',
    '探索外汇交易的专业知识、市场分析、交易心理、职业交易员经验分享。涵盖外汇、黄金、数字货三重等多个交易领域的深度文章。外汇交易员培训和全职交易员培训资源库。',
    ...
    '外汇博客, 交易知识, 外汇交易员培训, 全职交易员培训, 市场分析, 交易心理, 职业交易员, 外汇交易技巧, 黄金交易, 数字货三重交易, 交易策略分享, 市场洞察',
