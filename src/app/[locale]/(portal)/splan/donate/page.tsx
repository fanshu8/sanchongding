    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="max-w-6xl mx-auto px-6 py-20 space-y-20">
        ...
        >
          ...
          <div className="relative bg-primary p-12 border-2 border-black dark:border-white shadow-2xl">
          ...
          <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 border-2 border-gray-200 dark:border-gray-700 p-10">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <LocaleLink
                ...
                className="px-10 py-5 bg-secondary hover:bg-secondary/80 text-white font-bold text-lg transition-all border-2 border-transparent text-center hover:shadow-lg"
              >
                {t('donate.how.cta.test')}
              </LocaleLink>
              <button
                onClick={() => setIsEmailModalOpen(true)}
                className="px-10 py-5 bg-accent hover:bg-accent/90 text-white font-bold text-lg border-2 border-transparent transition-all text-center hover:shadow-lg animate-shake"
              >
        ...
        >
          ...
          <div className="relative bg-primary p-10 border-2 border-black dark:border-white">
