...
export default function RiskRewardCalculatorPage() {
  ...
  // Input states
  const [entryPrice, setEntryPrice] = useState<string>('95000');
  const [stopLoss, setStopLoss] = useState<string>('94500');
  const [takeProfit, setTakeProfit] = useState<string>('96000');
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-black dark:text-white focus:ring-2 focus:ring-secondary focus:border-secondary outline-none"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-red-300 dark:border-red-700 bg-white dark:bg-gray-900 text-black dark:text-white focus:border-red-500 dark:focus:border-red-500 focus:ring-2 focus:ring-secondary outline-none"
                  placeholder="94500"
                  step="1"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-green-300 dark:border-green-700 bg-white dark:bg-gray-900 text-black dark:text-white focus:border-green-500 dark:focus:border-green-500 focus:ring-2 focus:ring-secondary outline-none"
                  placeholder="96000"
                  step="1"
                />
                <p className="text-xs text-gray-500 dark:text-gray-500 mt-1">
