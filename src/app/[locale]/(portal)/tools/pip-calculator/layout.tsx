...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return generateBilingualMetadata(
    '点值计算器丨三重鼎丨外汇交易员培训、职业交易员培训',
    'Pip Calculator丨SuncheerForex丨Forex Trader Training, Professional Trader Training',
    '免费在线外汇点值计算器，支持所有主要货三重对。精准计算每点价值，帮助职业交易员和日内交易员科学管理风险，提升交易精度。外汇交易员培训和职业交易员培训必备工具。',
