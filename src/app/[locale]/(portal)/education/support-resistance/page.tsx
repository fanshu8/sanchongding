          ...
          <div className="p-6 bg-black dark:bg-white text-white dark:text-black">
            ...
            <ul className="space-y-3">
              ...
              <li>
                ...
                {isZh
                  ? '在阻力位买入的交易者被套牢（如在1.2000买入BTC/USDT后价格下跌），当价格反弹至1.2000时，套牢者急于解套离场（卖出），制造阻力。同理，在支撑位做空被套，价格回落时会平仓（买入），制造支撑。'
                  : 'Traders who bought at resistance are trapped (e.g., bought BTC/USDT at 1.2000 then price fell), when price bounces back to 1.2000, trapped traders rush to exit (sell), creating resistance. Similarly, shorts trapped at support will close (buy) when price returns, creating support.'}
              </li>
              <li>
              ...
              <div className="p-4 bg-black dark:bg-white text-white dark:text-black mt-3">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li>
                    ...
                    {isZh ? '日线开盘价和收盘价常成为当日的支撑阻力，尤其在数字货三重市场（24小时交易，开盘价是0:00 GMT）。' : 'Daily open/close often become intraday S/R, especially in cryptocurrency (24hr trading, open is 0:00 GMT).'}
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="p-6 border-2 border-black dark:border-white">
            ...
            <div className="space-y-3 text-gray-700 dark:text-gray-300">
              ...
              <div className="p-4 bg-green-50 dark:bg-green-900/20 border-2 border-green-600 mt-3">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>{isZh ? '识别：BTC/USDT H4前高阻力1.1000（3次触及）' : 'Identify: BTC/USDT H4 previous high resistance 1.1000 (3 touches)'}</li>
          ...
          <div className="p-6 border-2 border-black dark:border-white">
            ...
            <div className="space-y-3 text-gray-700 dark:text-gray-300">
              ...
              <div className="p-4 bg-red-50 dark:bg-red-900/20 border-2 border-red-600">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>{isZh ? '识别：ETH/USDT H4前低支撑1.2650（2次触及）' : 'Identify: ETH/USDT H4 previous low support 1.2650 (2 touches)'}</li>
          ...
          <div className="p-6 bg-black dark:bg-white text-white dark:text-black">
            ...
            <ul className="space-y-3">
              ...
              <li>
                ...
                {isZh
                  ? '真突破伴随成交量显著放大（如有Tick Volume数据）。无量突破容易失败。数字货三重现货无真实成交量，可参考期货成交量。'
                  : 'True breakout accompanied by significantly increased volume (if Tick Volume data available). No-volume breakout easily fails. Cryptocurrency spot has no true volume, can reference futures volume.'}
              </li>
              <li>
