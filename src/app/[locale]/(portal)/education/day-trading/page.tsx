          ...
          <div className="p-6 border-2 border-black dark:border-white">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm mt-2">
                {isZh
                  ? '实际交易中可开0.6或0.7标准手，或使用Suncheer Forex仓位计算器自动计算。'
                  : 'In actual trading open 0.6 or 0.7 standard lots, or use Suncheer Forex position calculator for automatic calculation.'}
              </p>
            </div>
          </div>
