          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 border-2 border-green-600 bg-green-50 dark:bg-green-900/20">
              ...
              <ul className="list-disc pl-6 space-y-2 text-sm">
                ...
                <li>{isZh ? '适用所有市场（数字货三重、股票、期货、加密货三重）和所有时间框架' : 'Works in all markets (cryptocurrency, stocks, futures, crypto) and timeframes'}</li>
          ...
          <div className="p-6 border-2 border-black dark:border-white">
            ...
            <div className="space-y-3 text-gray-700 dark:text-gray-300">
              ...
              <div className="p-4 bg-black dark:bg-white text-white dark:text-black">
                ...
                <ul className="space-y-2 text-sm">
                  <li>{isZh ? 'BTC/USDT在1.1000位置（整数关口）' : 'BTC/USDT at 1.1000 (round number)'}</li>
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-800">
                ...
                <ul className="list-disc pl-6 space-y-2 text-sm">
                  <li>
                    ...
                    {isZh ? 'BTC/USDT处于上升趋势，价格在50 EMA上方，过去2周创造HH+HL。交易偏好：只做多。' : 'BTC/USDT in uptrend, price above 50 EMA, past 2 weeks made HH+HL. Trading bias: only long.'}
                  </li>
                  <li>
