      ...
      <section id="kelly-criterion" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6">
          <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              {isZh
                ? '凯利公式（Kelly Criterion）由数学家约翰·凯利于1956年提出，原用于信息论，后被应用于赌博和投资领域。它通过计算最优仓位百分比，理论上实现账户最快增长。在数字货三重交易中，凯利公式可以帮助我们根据策略的历史表现（胜率和盈亏比）确定科学的仓位大小。'
          ...
          <div className="p-6 bg-black dark:bg-white text-white dark:text-black">
            ...
            <div className="space-y-3 text-sm">
              ...
              <ul className="space-y-2">
                <li>
                  <strong>{isZh ? '1. Suncheer Forex Position Calculator：' : '1. Suncheer Forex Position Calculator:'}</strong>{' '}
                  {isZh
