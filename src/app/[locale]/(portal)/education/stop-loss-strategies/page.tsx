          ...
          <div className="p-6 bg-black dark:bg-white text-white dark:text-black">
            ...
            <ul className="space-y-3">
              ...
              <li>
                ...
                {isZh
                  ? '止损位置代表你的分析被证明错误的点。例如，你在支撑位1.1050做多BTC/USDT，止损设在1.1020（支撑位下方），如果触发止损，说明支撑失效，你的分析错误，应该认赔出场而非死扛。止损让你快速纠错，保留资金寻找下一个机会。'
                  : 'Stop-loss position represents point where your analysis is proven wrong. E.g., you long BTC/USDT at support 1.1050, stop at 1.1020 (below support), if stop hit, means support failed, your analysis wrong, should accept loss and exit not hold stubbornly. Stop-loss lets you quickly correct errors, preserve capital for next opportunity.'}
              </li>
            </ul>
          </div>
          ...
          <div className="p-6 border-2 border-black dark:border-white">
            ...
            <div className="space-y-3 text-gray-700 dark:text-gray-300">
              <p>
                ...
                {isZh
                  ? '无论交易对、时间框架或市场条件，始终使用固定点数作为止损距离。例如：所有BTC/USDT交易止损30点，所有GBP/JPY交易止损50点。'
                  : 'Regardless of trading pair, timeframe or market conditions, always use fixed pips as stop distance. E.g., all BTC/USDT trades stop 30 pips, all GBP/JPY trades stop 50 pips.'}
              </p>
              <div className="p-4 bg-gray-50 dark:bg-gray-800">
                <p className="font-bold mb-2">{isZh ? '实施步骤：' : 'Implementation Steps:'}</p>
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>{isZh ? '1. 根据交易对平均波动性确定固定点数（BTC/USDT: 20-30点，GBP/JPY: 40-60点）' : '1. Determine fixed pips based on pair average volatility (BTC/USDT: 20-30 pips, GBP/JPY: 40-60 pips)'}</li>
          ...
          <div className="p-6 border-2 border-black dark:border-white">
            ...
            <div className="space-y-3 text-gray-700 dark:text-gray-300">
              <p>
                <strong>{isZh ? '定义：' : 'Definition:'}</strong>{' '}
                {isZh
                  ? '基于入场价的固定百分比设置止损。例如：止损始终为入场价的0.5%（做多BTC/USDT在1.1000，止损在1.0945）。'
                  : 'Set stop based on fixed percentage of entry price. E.g., stop always 0.5% of entry price (long BTC/USDT at 1.1000, stop at 1.0945).'}
              </p>
              <div className="p-4 bg-gray-50 dark:bg-gray-800">
                <p className="font-bold mb-2">{isZh ? '计算示例：' : 'Calculation Example:'}</p>
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>{isZh ? '做多BTC/USDT，入场价1.1000' : 'Long BTC/USDT, entry 1.1000'}</li>
          ...
          <div className="p-6 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-600">
            ...
            <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
              <li>
                ...
                {isZh
                  ? '使用固定点数止损（BTC/USDT 20-30点），简单易执行，先建立止损习惯。'
                  : 'Use fixed pip stop (BTC/USDT 20-30 pips), simple to execute, first build stop habit.'}
              </li>
              <li>
      ...
      <section id="atr-stop-loss" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <div className="p-6 bg-black dark:bg-white text-white dark:text-black">
            ...
            <p className="mb-3">
              {isZh
                ? 'ATR值代表过去N个周期（通常14个）的平均波动幅度。例如，BTC/USDT的14期ATR为15点，意味着过去14根K线平均每根波动15点。'
          ...
          <div className="p-6 border-2 border-black dark:border-white">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-3">
                <p className="font-bold">{isZh ? '示例1：BTC/USDT日内交易' : 'Example 1: BTC/USDT Day Trading'}</p>
                <ul className="list-disc pl-6 space-y-1 text-sm">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 bg-green-50 dark:bg-green-900/20 border-2 border-green-600">
              ...
              <ul className="list-disc pl-6 space-y-2 text-sm">
                ...
                <li>{isZh ? '适用于所有交易对和时间框架' : 'Applicable to all pairs and timeframes'}</li>
