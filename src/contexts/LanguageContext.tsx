...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    // Hero Section
    'hero.title': '三重鼎：零风险试错，和优秀交易员一起赚钱',
    'hero.subtitle': '免费多空测试，100-200 美金实盘亏损公司担，分成 60%-90% | 立即测适配度',
    'hero.tagline': '20 个简单测评→免费培养→大额实盘高分成，仅 20-35 岁理性者可申请',
    'hero.cta.learn': '立即预约面试',
    'hero.cta.learn.note': '每人仅 1 次机会',
    'hero.cta.dashboard': '进入交易系统',
    'risk.assurance': '小额实盘阶段，账户资金由公司提供，交易亏损 100% 公司承担，仅扣除交易所基础手续费，无任何隐藏收费',
    ...
    // Advantages
    'advantage.selection.title': '为什么 85% 的人会被淘汰？（2024 年真实数据）',
    'advantage.selection.desc': '35% 因多空单量不足、28% 因考核漏单、22% 因小额回撤超标',
    'advantage.growth.title': '实盘收益',
    'advantage.growth.desc': '小额实盘（100-200 美金）：60% 分成，亏损公司承担；大额实盘（100K-2M 美金）：60%-90% 分成，仅对连续 4 周盈利者开放',
    'advantage.commission.title': '培养路径',
    'advantage.commission.desc': '阶梯式培养：1-3 天多空练习→3-10 天盈利练习→10 天盈利考核→4 周小额实盘→大额实盘（多空单量 < 15 单直接淘汰）',
    ...
    // Career Path
    'career.title': '职业发展路径',
    'career.subtitle': '阶梯式培养体系，从多空练习到大额实盘的完整路径',
    'career.stage1.days': '1-3 天',
    'career.stage1.title': '多空姿势练习',
    'career.stage1.desc': '核心：按规则练交易，无盈利要求；考核：日内单量≥15 单、不错单',
    'career.stage1.warning': ' 淘汰：单量不足 / 错单≥1 次直接淘汰',
    'career.stage2.days': '3-10 天',
    'career.stage2.title': '新增指标盈利练习',
    'career.stage2.desc': '核心：每日提交交易日志、搭建策略；考核：未提交日志超 2 天触发预警',
    'career.stage2.tip': ' 淘汰：预警超 2 次停训',
    'career.stage3.days': '10 天',
    'career.stage3.title': '盈利考核',
    'career.stage3.desc': '核心：连续 10 天不亏损、不错单；考核：日内单量 8-10 单',
    'career.stage3.success': ' 淘汰：未达标可重测 1 次，仍不达标淘汰',
    'career.stage4.path': '4 周',
    'career.stage4.title': '小额实盘',
    'career.stage4.desc': '资金：100-200 美金；分成：60% 每周结算；规则：每周盈利、总回撤 < 30%，亏损公司承担',
    'career.stage4.goal': ' 准入：通过盈利考核',
    'career.stage5.path': '长期',
    'career.stage5.title': '大额实盘',
    'career.stage5.desc': '资金：100K-2M 美金；分成：60%-90%',
    'career.stage5.goal': ' 准入：小额实盘连续 4 周盈利、总回撤 < 30%',
    ...
    'joinus.profile.basic.title': '硬性条件',
    'joinus.profile.basic.1': '大专及以上（金融 / 计算机优先）、35 岁以下（需学信网 / 身份证验证）',
    'joinus.profile.basic.2': '实操测试：多空模拟（1 天≥15 单）',
    'joinus.profile.basic.3': '风险应对测评',
    'joinus.profile.basic.4': '纪律性问卷（说谎率超 30% 淘汰）',
    ...
    'faq.category.course': '关于 Suncheer Forex',
    'faq.category.learning': '关于培训',
    'faq.category.pricing': '关于收入与分润',
    'faq.category.support': '交易铁律',
    'faq.category.other': '其他问题',
    'faq.contact.title': '其他问题',
    'faq.contact.desc': '发送问题到我们的邮箱，我们将尽快为您解答疑问',
    'faq.contact.button': '联系我们',
    'faq.contact.modal.title': '联系我们',
    ...
    'donate.how.step2.desc': '邮件至 2424802244@qq.com，说明您的意向',
  ...
  en: {
    ...
    'hero.tagline': '20 simple assessments → free training → high profit share with large live capital; only rational applicants aged 20–35 may apply',
    'hero.cta.learn': 'Learn About Crypto Training',
    'hero.cta.dashboard': 'Enter Trading System',
    'risk.assurance': 'During the small live trading phase, account capital is provided by the platform. 100% of trading losses are covered by the platform. Only basic exchange fees are deducted; no hidden charges.',

    // Why Choose Section
    'why.title': 'Why Choose Suncheer Forex',
    ...
    'comparison.fxkiller': 'Suncheer Forex',
    ...
    // Join Us Page
    'joinus.hero.badge': 'PROFESSIONAL TRADER TRAINING',
    'joinus.hero.title1': 'Suncheer Forex',
    ...
    'faq.category.course': 'About Suncheer Forex',
    ...
    'donate.how.step2.desc': 'Email to 2424802244@qq.com explaining your intention',
    ...
    'dashboard.footer.copyright': '2024-2025 © Suncheer Forex Professional Cryptocurrency Trader Training Platform',
    ...
    'blog.cta.subtitle': 'Join Suncheer Forex for professional cryptocurrency trader training',
