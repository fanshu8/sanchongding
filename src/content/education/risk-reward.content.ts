...
export const riskRewardContent = {
  zh: {
    title: '风险回报比详解 - R:R计算、最优比例与期望值优化完整指南 | Suncheer Forex',
    description: '深入讲解数字货三重交易风险回报比核心知识：R:R计算公式、盈亏比与胜率关系、期望值计算、目标设定策略、最优比例选择。职业交易员分享实战盈亏比优化技巧，助你实现长期稳定盈利。',
  ...
  en: {
    title: 'Risk-Reward Ratio Guide - R:R Calculation, Optimal Ratios & Expectancy Optimization | Suncheer Forex',
